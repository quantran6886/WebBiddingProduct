/// <reference path="pdf-editor-master/public/maketextpdf.js" />
/// <reference path="pdf-editor-master/public/maketextpdf.js" />
var app = (function () {
    "use strict";
    ...
    function ut(n, o, l, s) {
        ...
        function v(o) {
            const { delay: r = 0, duration: l = 300, easing: s = e, tick: v = t, css: x } = a || ct,
                b = {
                    start: h() + r,
                    b: o,
                };
                ...
                u
                    ...
                    : (x && (w(), (f = R(n, c, o, l, r, s, x))),
                        ...
                        (function (t) {
                            ...
                            if ((d && t > d.start && ((u = y(d, l)), (d = null), nt(n, u.b, "start"), x && (w(), (f = R(n, c, u.b, u.duration, 0, s, a.css)))), u))
                                if (t >= u.end) v((c = u.b), 1 - c), nt(n, u.b, "end"), d || (u.b ? w() : --u.group.r || i(u.group.c)), (u = null);
                                else if (t >= u.start) {
                                    const e = t - u.start;
                                    (c = u.a + u.d * s(e / u.duration)), v(c, 1 - c);
                                }
                            return !(!u && !d);
                        }));
        }
    ...
    function ft(t, e, n, o, i, r, l, s, a, c, u, d) {
        let f = t.length,
            h = r.length,
            p = f;
        const g = {};
        ...
        for (p = h; p--;) {
            const t = d(i, r, p),
                s = n(t);
            let a = l.get(s);
            a ? o && a.p(t, e) : ((a = c(s, t)), a.c()), w.set(s, (m[p] = a)), s in g && y.set(s, Math.abs(p - g[s]));
        }
        const v = new Set(),
            x = new Set();

        function b(t) {
            st(t, 1), t.m(s, u, l.has(t.key)), l.set(t.key, t), (u = t.first), h--;
        }
        for (; f && h;) {
            const e = m[h - 1],
                n = t[f - 1],
                o = e.key,
                i = n.key;
            e === n ? ((u = e.first), f--, h--) : w.has(i) ? (!l.has(o) || v.has(o) ? b(e) : x.has(i) ? f-- : y.get(o) > y.get(i) ? (x.add(o), b(e)) : (v.add(i), f--)) : (a(n, l), f--);
        }
        for (; f--;) {
            const e = t[f];
            w.has(e.key) || a(e, l);
    ...
    function pt(t, e, o) {
        const { fragment: l, on_mount: s, on_destroy: a, after_update: c } = t.$$;
        l && l.m(e, o),
            K(() => {
    ...
    function mt(t, e) {
        -1 === t.$$.dirty[0] && (Y.push(t), J || ((J = !0), I.then(Z)), t.$$.dirty.fill(0)), (t.$$.dirty[(e / 31) | 0] |= 1 << e % 31);
    }

    function wt(e, n, r, l, s, a, c = [-1]) {
        const u = T;
        B(e);
        const d = n.props || {},
            f = (e.$$ = {
        ...
        if (
            ((f.ctx = r
                ? r(e, d, (t, n, ...o) => {
                    ...
                    return f.ctx && s(f.ctx[t], (f.ctx[t] = i)) && (f.bound[t] && f.bound[t](i), h && mt(e, t)), n;
                })
                : []),
                f.update(),
                (h = !0),
            ...
            n.intro && st(e.$$.fragment), pt(e, n.target, n.anchor), Z();
        }
        B(u);
    }
    class yt {
    ...
    function xt(t, { delay: e = 0, duration: n = 400, easing: o = vt, x: i = 0, y: r = 0, opacity: l = 0 }) {
    ...
    function $t(e) {
        ...
        return {
            c() {
                (n = x("div")), (o = x("canvas")), z(o, "class", "max-w-full"), F(o, "width", e[1] + "px"), z(o, "width", e[1]), z(o, "height", e[2]);
            },
            m(t, i) {
                y(t, n, i), w(n, o), e[9](o);
            },
            p(t, [e]) {
                2 & e && F(o, "width", t[1] + "px"), 2 & e && z(o, "width", t[1]), 4 & e && z(o, "height", t[2]);
            },
            i: t,
            o: t,
            d(t) {
    ...
    function kt(t) {
        ...
        return (
            ...
            {
                destroy() {
                    t.removeEventListener("mousedown", o), t.removeEventListener("touchstart", l);
                },
            }
        );
    }
    const _t = [
        ...
        {
            name: "download",
            src: "/Library/PdfView/download.js",
        },
        {
            name: "urlPDF",
            src: "/Library/PdfView/urlPDF.js",
        },
        {
            name: "makeTextPDF",
            src: "/Library/PdfView/pdf-editor-master/public/makeTextPDF.js",
        },
    ],
        zt = {};
        ...
        return (
            ...
            (zt[t] = new Promise((n, o) => {
                ...
                (i.src = e),
                    ...
                    document.getElementById("reder-pdf-signature").appendChild(i);
            })),
            zt[t]
        );
    }
    ...
    function Pt(e) {
        ...
        return {
            ...
            m(t, f, h) {
                y(t, n, f), w(n, o), w(n, l), w(n, s), w(n, a), w(n, c), e[24](c), h && i(u), (u = [d((r = kt.call(null, o))), k(o, "panstart", e[12]), k(o, "panmove", e[10]), k(o, "panend", e[11]), k(s, "click", e[13])]);
            },
            p(t, [e]) {
    ...
    function Tt(t, e, n) {
        ...
        let d,
            ...
            x = null;
        async function b() {
            n(4, (h.width = r), h), n(4, (h.height = l), h), h.getContext("2d").drawImage(o, 0, 0);
            let t = 1;
            r > 500 && (t = 500 / r),
                l > 500 && (t = Math.min(t, 500 / l)),
                u("update", {
                    width: r * t,
                    height: l * t,
                }),
            ...
            [
                ...
                function (t) {
                    const e = (t.detail.x - d) / c,
                        o = (t.detail.y - f) / c;
                    if ("move" === p) return n(6, (m = e)), void n(7, (w = o));
                    "scale" === p &&
                        ("left" === g
                            ? (n(8, (y = -e)), null !== x && n(8, ([y, v] = $(y, -1 / 0)), y, n(9, v)), n(6, (m = -y)))
                            : "left-top" === g
                                ? (n(8, (y = -e)), n(9, (v = -o)), null !== x && n(8, ([y, v] = $(y, v)), y, n(9, v)), n(7, (w = -v)), n(6, (m = -y)))
                                : "top" === g
                                    ? (n(9, (v = -o)), null !== x && n(8, ([y, v] = $(-1 / 0, v)), y, n(9, v)), n(7, (w = -v)))
                                    : "right-top" === g
                                        ? (n(8, (y = e)), n(9, (v = -o)), null !== x && n(8, ([y, v] = $(y, v)), y, n(9, v)), n(7, (w = -v)))
                                        : "right" === g
                                            ? (n(8, (y = e)), null !== x && n(8, ([y, v] = $(y, -1 / 0)), y, n(9, v)))
                                            : "right-bottom" === g
                                                ? (n(8, (y = e)), n(9, (v = o)), null !== x && n(8, ([y, v] = $(y, v)), y, n(9, v)))
                                                : "bottom" === g
                                                    ? (n(9, (v = o)), null !== x && n(8, ([y, v] = $(-1 / 0, v)), y, n(9, v)))
                                                    : "left-bottom" === g && (n(8, (y = -e)), n(9, (v = o)), null !== x && n(8, ([y, v] = $(y, v)), y, n(9, v)), n(6, (m = -y))));
                },
                function (t) {
                    "move" === p
                        ? (u("update", {
                ...
                function (t) {
                    ...
                    n(5, (p = "scale")), (g = t.detail.target.dataset.direction);
                },
                function () {
                    u("delete");
                },
    ...
    function At(t, e, n) {
        ...
        return (
            ...
            (t.$$.update = () => {
                1 & t.$$.dirty && o && document.getElementById("reder-pdf-signature").appendChild(o);
            }),
            [
                o,
                r,
    ...
    function Wt(t) {
        ...
        return {
            c() {
                (e = x("div")), i && i.c(), z(e, "class", "z-10 top-0 left-0 right-0 h-12");
            },
            m(t, o) {
    ...
    function Jt(t) {
        let e,
            ...
            A = t[9],
            B = [];
        for (let e = 0; e < A.length; e += 1) B[e] = It(Ut(t, A, e));
        return {
            c() {
                (e = x("div")),
                    (n = x("div")),
                ...
                (C = E()),
                    ...
                    (P = E()),
                    (T = x("div")),
                    (T.innerHTML = '<img class="w-full h-full" src="/Library/PdfView/pdf-editor-master/public/delete.svg" alt="delete object">'),
                    o.src !== (r = "/line_height.svg") && z(o, "src", "/line_height.svg"),
                    z(o, "class", "w-6 mr-2"),
                    z(o, "alt", "Line height"),
                    z(s, "type", "number"),
                    z(s, "min", "1"),
                    z(s, "max", "10"),
                    z(s, "step", "0.1"),
                    z(s, "class", "h-6 w-12 text-center flex-shrink-0 rounded-sm"),
                    z(n, "class", "mr-2 flex items-center"),
                    u.src !== (f = "/text.svg") && z(u, "src", "/text.svg"),
                    z(u, "class", "w-6 mr-2"),
                    z(u, "alt", "Font size"),
                    z(p, "type", "number"),
                    z(p, "min", "12"),
                    ...
                    b.src !== ($ = "/text-family.svg") && z(b, "src", "/text-family.svg"),
                    z(b, "class", "w-4 mr-2"),
                    z(b, "alt", "Font family"),
            ...
            m(r, f, v) {
                y(r, e, f), w(e, n), w(n, o), w(n, l), w(n, s), S(s, t[4]), w(e, a), w(e, c), w(c, u), w(c, h), w(c, p), S(p, t[3]), w(e, g), w(e, m), w(m, b), w(m, L), w(m, _), w(_, F);
            ...
            p(t, e) {
                if ((16 & e[0] && H(s.value) !== t[4] && S(s, t[4]), 8 & e[0] && H(p.value) !== t[3] && S(p, t[3]), 512 & e[0])) {
                    let n;
        ...
        return {
            c() {
                f && f.c(),
                    ...
                    z(s, "contenteditable", "true"),
                    z(s, "spellcheck", "false"),
                    z(s, "class", "outline-none whitespace-no-wrap"),
                    F(s, "font-size", t[3] + "px"),
                    F(s, "font-family", "'" + t[5] + "', serif"),
                    F(s, "line-height", t[4]),
                    F(s, "-webkit-user-select", "text"),
                    z(n, "class", "absolute left-0 top-0 select-none"),
            ...
            p(t, i) {
                t[8]
                    ? f
                        ? (f.p(t, i), 256 & i[0] && st(f, 1))
                        : ((f = qt(t)), f.c(), st(f, 1), f.m(e.parentNode, e))
                    : f &&
                    (rt(),
                        at(f, 1, 1, () => {
                            f = null;
                    ...
                    (!c || 8 & i[0]) && F(s, "font-size", t[3] + "px"),
                    (!c || 32 & i[0]) && F(s, "font-family", "'" + t[5] + "', serif"),
                    (!c || 16 & i[0]) && F(s, "line-height", t[4]),
                ...
                function (t) {
                    ...
                    if (13 === t.keyCode) {
                        ...
                        const n = window.getSelection(),
                            o = n.focusNode,
                            i = n.focusOffset;
                        if (o === p) p.insertBefore(document.createElement("br"), e[i]);
                        else if (o instanceof HTMLBRElement) p.insertBefore(document.createElement("br"), o);
                        else if (o.textContent.length !== i) document.execCommand("insertHTML", !1, "<br>");
                        else {
                            let t = o.nextSibling;
    ...
    function Zt(e) {
        ...
        return {
            ...
            m(t, h, p) {
                y(t, n, h), w(n, o), w(n, l), w(n, s), w(n, a), w(n, c), w(c, u), e[22](c), p && i(f), (f = [d((r = kt.call(null, o))), k(o, "panstart", e[12]), k(o, "panmove", e[10]), k(o, "panend", e[11]), k(s, "click", e[13])]);
            },
            p(t, [e]) {
                32 & e && C(o, "cursor-grabbing", "move" === t[5]),
                    32 & e && C(o, "operation", t[5]),
        ...
        return {
            c() {
                (n = x("div")),
                    ...
                    z(s, "class", "w-24 bg-blue-600 hover:bg-blue-700 text-white font-bold py-1 px-4\n      rounded"),
            ...
            m(t, p, g) {
                y(t, n, p),
                    ...
                    e[16](n),
                    g && i(h),
                    (h = [k(r, "click", e[6]), k(s, "click", e[5]), d((f = kt.call(null, n))), k(n, "panstart", e[2]), k(n, "panmove", e[3]), k(n, "panend", e[4])]);
            },
            p(t, [e]) {
                2 & e && z(u, "d", t[1]);
            },
    ...
    function oe(t, e, n) {
        ...
        return [
            ...
            function (t) {
                ...
                (h = !0), (r = t.detail.x), (l = t.detail.y), (a = Math.min(a, r)), (c = Math.max(c, r)), (u = Math.min(u, l)), (d = Math.max(d, l)), f.push(["M", r, l]), n(1, (s += `M${r},${l}`));
            },
            function (t) {
                h && ((r = t.detail.x), (l = t.detail.y), (a = Math.min(a, r)), (c = Math.max(c, r)), (u = Math.min(u, l)), (d = Math.max(d, l)), f.push(["L", r, l]), n(1, (s += `L${r},${l}`)));
            },
            function () {
                h = !1;
            },
    ...
    function se(e) {
        ...
        return (
            ...
            {
                c() {
                    (n = x("div")), ht(r.$$.fragment), z(n, "class", "z-10 top-0 left-0 right-0 border-b border-gray-300 bg-white\n      shadow-lg"), F(n, "height", "50%");
                },
                m(t, e) {
    ...
    function ae(e) {
        ...
        return {
            c() {
                (n = x("div")), (n.innerHTML = '<span class=" font-bold text-3xl text-gray-500">Chọn tài liệu ký</span>'), z(n, "class", "w-full flex-grow flex justify-center items-center");
            },
            m(t, e) {
                y(t, n, e);
            },
    ...
    function ce(t) {
        ...
        return {
            c() {
                (e = x("div")), (n = x("img")), (i = E()), (r = x("input")), (l = E()), (s = x("div"));
                for (let t = 0; t < u.length; t += 1) u[t].c();
                n.src !== (o = "/edit.svg") && z(n, "src", "/edit.svg"),
                    z(n, "class", "mr-2"),
                    z(n, "alt", "a pen, edit pdf name"),
                    z(r, "placeholder", "Đổi tên tài liệu"),
                    z(r, "type", "text"),
                    z(r, "class", "flex-grow bg-transparent"),
                    z(e, "class", "flex justify-center px-5 w-full hidden"),
                    z(s, "class", "w-full overflowheight");
            },
            m(o, d, f) {
                y(o, e, d), w(e, n), w(e, i), w(e, r), S(r, t[1]), y(o, l, d), y(o, s, d);
                for (let t = 0; t < u.length; t += 1) u[t].m(s, null);
                (a = !0), f && c(), (c = k(r, "input", t[29]));
            },
            p(t, e) {
                if ((2 & e[0] && r.value !== t[1] && S(r, t[1]), 254012 & e[0])) {
                    const n = t[2];
                    rt(), (u = ft(u, e, h, 1, t, n, d, s, dt, pe, null, le)), lt();
                }
            },
            i(t) {
                if (!a) {
                    for (let t = 0; t < f.length; t += 1) st(u[t]);
                    a = !0;
                }
            },
            o(t) {
    ...
    function he(t, e) {
        ...
        return (
            ~(o = c(e)) && (i = a[o] = s[o](e)),
            {
                ...
                m(t, e) {
                    y(t, n, e), ~o && a[o].m(t, e), y(t, r, e), (l = !0);
                },
                p(t, e) {
                    let n = o;
                    (o = c(t)),
                        o === n
                            ...
                            : (i &&
                                (rt(),
                                    ...
                                    lt()),
                                ~o ? ((i = a[o]), i || ((i = a[o] = s[o](t)), i.c()), st(i, 1), i.m(r.parentNode, r)) : (i = null));
                },
                i(t) {
                    l || (st(i), (l = !0));
                },
    ...
    function pe(t, e) {
        ...
        return {
            ...
            first: null,
            c() {
                (n = x("div")), (o = x("div")), ht(f.$$.fragment), (r = E()), (l = x("div"));
                for (let t = 0; t < u.length; t += 1) u[t].c();
                (s = E()),
                    z(l, "class", "absolute top-0 left-0 transform origin-top-left"),
                    F(l, "transform", "scale(" + e[3][e[41]] + ")"),
                    F(l, "touch-action", "none"),
                    z(o, "class", "relative shadow-lg"),
                    C(o, "shadow-outline", e[41] === e[5]),
                    z(n, "class", "p-1 w-full flex flex-col items-center overflow-hidden"),
                    (this.first = n);
            },
            m(t, e, d) {
                y(t, n, e), w(n, o), pt(f, o, null), w(o, r), w(o, l);
            ...
            p(t, n) {
                ...
                if ((4 & n[0] && (i.page = e[39]), f.$set(i), 106524 & n[0])) {
                    const t = e[4][e[41]];
                    rt(), (u = ft(u, n, p, 1, e, t, d, l, dt, he, null, re)), lt();
                }
                (!a || 12 & n[0]) && F(l, "transform", "scale(" + e[3][e[41]] + ")"), 36 & n[0] && C(o, "shadow-outline", e[41] === e[5]);
            },
            i(t) {
                if (!a) {
                    st(f.$$.fragment, t);
            ...
            (O = J[N] = I[N](t)),
            {
                c() {
                    ht(U.$$.fragment),
                        ...
                        (a = E()),
                        (c = x("label")),
                        (c.textContent = "Chọn file PDF"),
                        (u = E()),
                        (d = x("div")),
                        (f = x("label")),
                        (f.innerHTML = '<img src="/Library/PdfView/pdf-editor-master/public/image.svg" alt="An icon for adding images">'),
                        (h = E()),
                        (p = x("label")),
                        (p.innerHTML = '<img src="/Library/PdfView/pdf-editor-master/public/notes.svg" alt="An icon for adding text">'),
                        (g = E()),
                        (m = x("label")),
                        (m.innerHTML = '<img src="/Library/PdfView/pdf-editor-master/public/gesture.svg" id="btnChuKyDienTu" alt="An icon for adding drawing">'),
                        (b = E()),
                        (L = x("div")),
                        (H = x("img")),
                        (M = E()),
                        ...
                        z(s, "name", "image"),
                        z(s, "class", "hidden"),
                        z(c, "class", "btn btn-secondary p-2 mr-3 m-0"),
                        z(c, "for", "pdf"),
                        ...
                        H.src !== (F = "/Library/PdfView/pdf-editor-master/public/edit.svg") && z(H, "src", "/Library/PdfView/pdf-editor-master/public/edit.svg"),
                        z(H, "class", "mr-2"),
                        z(H, "alt", "a pen, edit pdf name"),
                        z(j, "placeholder", "Đổi tên tài liệu"),
                        z(j, "type", "text"),
                        z(j, "class", "flex-grow bg-transparent"),
                        z(L, "class", "justify-center mr-3 md:mr-4 w-full max-w-xs hidden"),
                        z(T, "class", "btn btn-secondary ctx_file_geturl p-2 mr-3 m-0 hidden"),
                        ...
                        z(o, "class", "w-100 z-10 top-0 left-0 right-0 h-12 flex justify-center items-center\n    bg-gray-200 border-b border-gray-300"),
                        z(n, "class", "flex flex-col items-center bg-gray-500 min-h-screen");
                },
                m(v, x, $) {
                    pt(U, v, x),
                        y(v, e, x),
                        ...
                        $ && i(Y),
                        (Y = [
                            k(window, "dragenter", _(t[24])),
                            k(window, "dragover", _(t[25])),
                            k(window, "drop", _(t[8])),
                            k(r, "change", t[8]),
                            k(s, "change", t[9]),
                            k(p, "click", t[10]),
                ...
                p(t, e) {
                    32 & e[0] && C(f, "cursor-not-allowed", t[5] < 0),
                        ...
                        t[7]
                            ? q
                                ? (q.p(t, e), 128 & e[0] && st(q, 1))
                                : ((q = se(t)), q.c(), st(q, 1), q.m(n, W))
                            : q &&
                            (rt(),
                                at(q, 1, 1, () => {
                                    q = null;
                ...
                i(t) {
                    X || (st(U.$$.fragment, t), st(q), st(O), (X = !0));
                },
                o(t) {
                    at(U.$$.fragment, t), at(q), at(O), (X = !1);
                },
                d(t) {
                    gt(U, t), t && v(e), t && v(n), q && q.d(), J[N].d(), i(Y);
                },
            }
        );
    }
    ...
    function me(t, e, n) {
        ...
        async function p(t) {
            try {
                if (typeof t === 'string' && t.startsWith("data:image") && t.includes("base64")) {
                    const i = t;
                    r = await ((e = i),
                        new Promise((t, n) => {
                            const o = new Image();
        ...
        //async function p2(base64Image) {
        //    try {
        //        // Tạo một đối tượng hình ảnh từ base64 string
        //        const image = new Image();

        //        // Khi hình ảnh được tải xong
        //        image.onload = () => {
        //            // Lấy kích thước của hình ảnh
        //            const width = image.width;
        //            const height = image.height;

        //            // Tạo đối tượng d để lưu thông tin về hình ảnh
        //            const d = {
        //                id: base64Image, // Dùng base64 string làm ID hoặc payload
        //                type: "image",
        //                width: width,
        //                height: height,
        //                x: 0, // Vị trí X của hình ảnh trên trang PDF (hoặc trong tài liệu)
        //                y: 0, // Vị trí Y của hình ảnh trên trang PDF (hoặc trong tài liệu)
        //                payload: base64Image, // Dữ liệu hình ảnh base64
        //                file: null // Không cần file gốc nếu đã có base64
        //            };

        //            // Thực hiện các hành động cần thiết với dữ liệu `d` (ví dụ, chèn vào PDF)
        //            n(4, (a = a.map((t, e) => (e === u ? [...t, d] : t))));
        //        };

        //        // Đặt src của hình ảnh để tải hình ảnh từ base64
        ...
        N(async () => {
            try {
                const t = await fetch("/Library/PdfView/pdf-editor-master/public/test.pdf"),
                    e = await t.blob();
                await h(e),
                    n(5, (u = 0)),
                    setTimeout(() => {
                ...
                if (i  /*&&!d && l.length*/) {
                    ...
                    try {
                        await (async function (t, e, n) {
                            ...
                            let l;
                            try {
                                l = await o.PDFDocument.load(await jt(t));
                            } catch (t) {
                                throw (console.log("Failed to load PDF."), t);
                            }
                            const s = l.getPages().map(async (t, n) => {
                                const i = e[n],
                                    s = t.getHeight(),
                                    a = i.map(async (e) => {
                                        if ("image" === e.type) {
                                            ...
                                            try {
                                                return (
                                                    (n = "image/jpeg" === o.type ? await l.embedJpg(await jt(o)) : await l.embedPng(await jt(o))),
                                                    () =>
                                                        t.drawImage(n, {
                                                            x: i,
                                                            y: s - r - c,
                            ...
                            await Promise.all(s);
                            try {
                                i(await l.save(), n, "application/pdf");
                            } catch (t) {
    ...
    return (
        ...
        new (class extends yt {
            constructor(t) {
                super(), wt(this, t, me, ge, l, {}, [-1, -1]);
            }
        })({
            target: document.getElementById("reder-pdf-signature"),
        })
    );
})();
